...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="/home/hustcsib2/OYJY/IconMatting/in-context-matting-main/12-0.00800-mat.pth",
    )
    parser.add_argument(
        "--save_path",
        type=str,
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/home/hustcsib2/OYJY/IconMatting/in-context-matting-main/config/eval.yaml",
    )
    parser.add_argument(
        "--seed",
        type=int,
