...
from icm.criterion.matting_criterion_eval import compute_mse_loss_torch, compute_sad_loss_torch, compute_gradient_loss_torch, compute_connectivity_error_torch
...
class InContextMatting(pl.LightningModule):
    ...
    def __compute_and_log_mse_sad_of_one_sample(self, pred, label, trimap, prefix="val"):
        ...
        grad_loss_unknown_ = compute_gradient_loss_torch(pred, label, trimap)
        conn_loss_unknown_ = compute_connectivity_error_torch(pred, label, trimap, step=0.1)
        ...
        grad_loss_all_ = compute_gradient_loss_torch(pred, label, trimap)
        conn_loss_all_ = compute_connectivity_error_torch(pred, label, trimap, step=0.1)
